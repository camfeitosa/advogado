import agnaldo from "../../public/agnaldo.jpg";
...
export function Sobre() {
  return (
    <section className="bg-white pb-14 md:px-20 md:h-[70vh]" id="Sobre">
      <div
        className="flex flex-col gap-6 md:justify-between md:flex-row-reverse"
        data-aos="fade-in"
      >
        <div className="flex flex-col gap-6 items px-6  md:w-[90%]">
          ...
          <img src={favicon} className="w-1/5 md:w-1/6 md:mt-4" alt="Logo AAS" />
        </div>

        <div className="flex items-center justify-center rounded-xl md:w-[60%]">
          <img src={agnaldo} className="w-[70%] rounded-lg" alt="" />
        </div>
      </div>
