      ...
      <div className="flex flex-col-reverse lg:grid lg:grid-cols-3 lg:px-20" id="Contato">
        ...
        <div className="contato lg:col-span-2 bg-[#0C1A26] py-6 flex gap-6 flex-col items-center text-white w-full">
          ...
          <div className="px-6 items-center text-center flex flex-col gap-2">
            ...
            <p className="font-light">Conte comigo para esclarecer suas dúvidas e proteger seus direitos!</p>
          </div>
        ...
        <div className="contatos py-6 pb-12 flex gap-10 flex-col items-center text-white w-full bg-[#0F1E2D]">
          ...
          <div className="px-6 items-center text-center flex flex-col gap-2">
            <h2 className="text-3xl mt-6 border-b-4 border-[#D0A854] border-1/2 mb-2">Contatos</h2>
            <p className="font-light">Entre em contato pelos canais disponíveis</p>
          </div>
          ...
          <div className="links flex flex-col gap-2 w-1/2 items-center">
            ...
            <a href="https://www.instagram.com/agnaldo.direito/" rel="noopener noreferrer" target="_blank">@agnaldo.direito</a>
          </div>
