...
export function Form() {
  ...
  return (
    <form onSubmit={sendEmail} className="px-6 w-full md:w-[55%] flex flex-col gap-8">
      ...
      <input type="submit" value="Enviar" className="py-4 px-6 text-[#0C1A26]  font-semibold bg-[#D0A854] w-fit radius"/>
