  ...
  return (
    <header className="flex justify-between md:justify-around px-6 md:px-2 py-4 items-center border-b shadow-lg w-full bg-white fixed top-0 left-0 z-10">
      ...
      <nav className="hidden md:flex">
        <ul className="flex gap-12 w-full text-slate-800 font-medium">
          <li>
            <a
              href="#Inicio"
              className={activeLink === "#Inicio" ? "menu-item active" : "menu-item"}
          ...
          <li>
            <a
              href="#Sobre"
              className={activeLink === "#Sobre" ? "menu-item active" : "menu-item"}
          ...
          <li>
            <a
              href="#Servicos"
              className={activeLink === "#Servicos" ? "menu-item active" : "menu-item"}
          ...
          <li>
            <a
              href="#Contato"
              className={activeLink === "#Contato" ? "menu-item active" : "menu-item"}
      ...
      <div className="link hidden md:flex gap-6">
        <a
          href="https://www.instagram.com/agnaldo.direito/"
